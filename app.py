...
if jogos_dia_file:
    ...
    palavras_indesejadas = (
        'UEFA|AFC Champions|Reservas|Friendlies Women\'s International|U21|English Premier League 2|Israeli Cup|Friendly Matches|Malaysian Cup|Copa de França|Copa de Inglaterra|Scottish FA Cup|U23|Sub23|Cup|Copa|CAF Champions League|English FA Women's Super League 1'
    )
   ...
   # Filtrar jogos com base nos critérios
    ...
    # Garantir que a coluna 'Aproveitamento' está no formato correto (numérico)
       ...
       # Filtrar jogos com base nos critérios
        away_home_jogos = jogos_dia_validos[
